/**
 * const prefixCls = 'style-112279';
 * const images = '/static/images/src/bbs/floor/Detail';
 * @Author: czy0729
 * @Date: 2018-09-04 17:29:39
 * @Last Modified by: czy0729
 * @Last Modified time: 2018-10-28 02:49:11
 * @Path m.benting.com.cn /src/bbs/floor/Detail/_Score.js
 */
      ...
      {!!list.length && (
        ...
        >
          {list
            .filter(
              item =>
                item.faceImg !== 'static/uploads/png/20170519/591e5f9e2c2bc.png'
            )
            .map(item => (
              <Img
                key={item.userId}
          ...
          <span className="t-30 l-64 t-sub ml-8 mt-4">{allnum}人加分</span>
        </Flex>
      )}
