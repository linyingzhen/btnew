/**
 * const prefixCls = 'style-191192';
 * const images = '/static/images/src/event/car/Index';
 * @Author: czy0729
 * @Date: 2018-11-06 15:09:09
 * @Last Modified by: czy0729
 * @Last Modified time: 2018-11-23 17:46:38
 * @Path bt_mb_new /src/event/car/Index/store.js.git
 */
...
export default class Store extends common {
  ...
  fetch = {
    ...
    vote: () => {
      ...
      return this.fetchThenSetState('get_event-car_statistics', 'vote', {
        tid: id
      });
    },
    ...
    signup: () => {
      ...
      return this.fetchThenSetState('get_event-car_sign-up-list', 'signup', {
        _: {
          search: {
            tid: id
          }
  ...
  storeInit() {
    ...
    this.setState({ page: 0 }, '_affixTabs');
  }
}
