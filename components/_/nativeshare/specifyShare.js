...
function shareToQZone4Web() {
  ...
  location.href = `http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?${generateQueryString(
    queryObj,
    true
  )}`;
}
...
function shareToWeibo4Web() {
  ...
  location.href = `http://service.weibo.com/share/share.php?${generateQueryString(
    queryObj,
    true
  )}`;
}
